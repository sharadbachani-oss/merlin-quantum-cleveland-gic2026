...
![Figure 2 — 156-qubit K=6 map on KRAS (ibm_fez): hardware |C(i, active)| by lattice distance; exact values are < 2×10⁻⁴ beyond the short-range cells and the device matches them at 119 of 120 pairs — the rise with distance is the device baseline.](C:/quantum ai 2026/CLEVELAND_SUBMISSION_PACKAGE/figures/fig1_k6_front.png)
